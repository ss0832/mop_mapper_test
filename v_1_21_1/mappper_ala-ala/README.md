...
> 2. **Model Identification**: While labeled `ala-ala`, the molecular model used for all simulations and kinetic analyses is **_N_-acetyl-_N_'-methylalaninamide (Ac-Ala-NHMe)**. 
>
